ActionController::Routing::Routes.draw do |map|
  ...
  map.namespace :admin do |admin|
    ...
    admin.resources :product_sets, :collection => {:edit_items => [:get],:search_ps => [:get],:product_form => [:get],:confirm => [:get],:regist => [:post] ,:search => [:get]},:member =>{:del =>[:get],:reset => [:get],:delete_ps_ids => [:get]}

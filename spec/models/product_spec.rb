...
describe Product do
  ...
  describe "その他" do
    ...
    it "CSVアップロード" do
      ...
      Product.add_by_csv("#{RAILS_ROOT}/spec/csv/product_csv_upload_for_spec.csv", 1)
      ...
      #CSVアップロード
      Product.add_by_csv("#{RAILS_ROOT}/spec/csv/product_csv_upload_image_for_spec.csv", 1)
